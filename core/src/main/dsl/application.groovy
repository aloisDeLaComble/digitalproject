...
domainBuilder.Domain(projectName:'digitalproject', mute:true, includeDirectory:project.properties['srcDir']) {
...
manageModule.exportModule('digitalproject',domainBuilder,frontendBuilder,project.properties['outputDir'])
